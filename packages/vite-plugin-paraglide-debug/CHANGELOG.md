...
- Browser extension API support via `window.__paraglideBrowserDebug`
...
### Added
- Initial release
- Basic Vite plugin for Paraglide debug metadata injection
- Virtual module system for runtime code (`/@paraglide-debug/*`)
- Debug middleware for serving translations at `/@paraglide-debug/langs.json`
