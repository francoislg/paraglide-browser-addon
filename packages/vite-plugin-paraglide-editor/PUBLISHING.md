...
This document provides a comprehensive checklist for publishing `vite-plugin-paraglide-editor` to npm.
...
- [ ] Create git tag:
  ```bash
  git tag vite-plugin-paraglide-editor@X.Y.Z
  ```
...
4. **Verify** on npm:
   - Visit https://www.npmjs.com/package/vite-plugin-paraglide-editor
...
1. **Create GitHub release**:
   ...
   - Tag: `vite-plugin-paraglide-editor@X.Y.Z`
   - Title: `vite-plugin-paraglide-editor v.X.Y.Z`
...
- [ ] Create GitHub release:
  - Tag: `vite-plugin-paraglide-editor@X.Y.Z`
  - Title: `vite-plugin-paraglide-editor vX.Y.Z`
...
2. **Deprecate broken version**:
   ```bash
   npm deprecate vite-plugin-paraglide-editor@X.Y.Z "Critical bug, use vX.Y.Z+1 instead"
   ```
...
3. **Deprecate wrong version**:
   ```bash
   npm deprecate vite-plugin-paraglide-editor@X.Y.Z "Incorrect version, use vX.Y.Z+1"
   ```
...
# Deprecate a version
npm deprecate vite-plugin-paraglide-editor@X.Y.Z "Reason here"

# Unpublish (within 72 hours)
npm unpublish vite-plugin-paraglide-editor@X.Y.Z

# Check package info
npm info vite-plugin-paraglide-editor

# View all versions
npm info vite-plugin-paraglide-editor versions
```
